...
TOKEN = '5665091234:AAErDj-qFj8WvqMMPDA-N26WFi8C08_1HbA'
bot = Bot(token=TOKEN)
...
async def text(message: types.Message):
    if message.text.startswith('https://www.tiktok.com'):
        ...
        await bot.send_message(chat_id=message.chat.id, text='Я тебя не понял, отправь мне ссылку на видео TikTok. Создатель: @drenix_x')
